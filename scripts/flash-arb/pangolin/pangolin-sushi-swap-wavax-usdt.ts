...
const runBot = async () => {
    try {
        ...
        const interval = setInterval(async () => {
            await swapMainToPartner(expandTo18Decimals(1), pangolinTokenPair, sushiTokenPair, wavax, usdt, usdtPrice, pangolinLiquidityCompute, sushiSwapLiquidityCompute, flashSwapContact);
