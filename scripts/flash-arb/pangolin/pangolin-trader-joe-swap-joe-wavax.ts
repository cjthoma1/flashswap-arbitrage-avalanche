...
const runBot = async () => {
    try {
        ...
        const interval = setInterval(async () => {
            await swapMainToPartner(expandTo18Decimals(50), pangolinTokenPair, traderJoeTokenPair, joeToken, wavax, pangolinLiquidityCompute, traderJoeLiquidityCompute, flashSwapContact);
