...
const runBot = async () => {
    try {
        ...
        const interval = setInterval(async () => {
            await swapMainToPartner(expandTo18Decimals(25), pangolinTokenPair, traderJoeTokenPair, joeToken, wavax, wavaxPrice, pangolinLiquidityCompute, traderJoeLiquidityCompute, flashSwapContact);
