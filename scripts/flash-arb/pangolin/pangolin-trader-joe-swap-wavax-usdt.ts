...
const runBot = async () => {
    try {
        ...
        const interval = setInterval(async () => {
            await swapMainToPartner(expandTo18Decimals(1), pangolinTokenPair, traderJoeTokenPair, wavax, usdt, usdtPrice, pangolinLiquidityCompute, traderJoeLiquidityCompute, flashSwapContact);
