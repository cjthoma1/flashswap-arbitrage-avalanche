...
const runBot = async () => {
    ...
    const blockListener = ethers.provider.on("block", async (blockNumber) => {
        ...
        await swapMainToPartner(expandTo18Decimals(4), pangolinTokenPair, traderJoeTokenPair, wavax, usdt, pangolinLiquidityCompute, traderJoeLiquidityCompute, flashSwapContact);
